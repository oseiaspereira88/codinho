...
| 05 | `cmd-codinho` | `cmd/codinho` | `go` | 103 | 1897 | 12 | `verified` | [cmd-codinho.md](./cmd-codinho.md) |
| 06 | `docs` | `docs` | `n/a` | 0 | 0 | 0 | `verified` | [docs.md](./docs.md) |
| 07 | `internal-ciassurance` | `internal/ciassurance` | `go` | 91 | 277 | 3 | `verified` | [internal-ciassurance.md](./internal-ciassurance.md) |
| 08 | `internal-mcpserver` | `internal/mcpserver` | `go` | 1444 | 2057 | 28 | `verified` | [internal-mcpserver.md](./internal-mcpserver.md) |
| 09 | `packs` | `packs` | `n/a` | 0 | 0 | 0 | `verified` | [packs.md](./packs.md) |
| 10 | `scripts` | `scripts` | `shell` | 183 | 0 | 6 | `verified` | [scripts.md](./scripts.md) |
