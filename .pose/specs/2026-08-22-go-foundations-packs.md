...
- [ ] Aprofundar quatro conceitos iniciais de go-first-steps (declaração curta, slice, tipos nomeados e zero values), com exemplos isolados, relações válidas e preservação dos desafios; validar catálogo. Consumir knowledge:go-foundations-io-batch.
