...
> **Data de Avaliação**: 2026-08-24T01:06:22Z
> **Baseline Commit**: c5edd1644af1
...
- **Linhas de Código de Produção**: 9931
- **Linhas de Código de Testes**: 8931
- **Total Geral de Linhas de Código**: 18862
- **Total de Arquivos Auditados**: 160
- **Completude Dinâmica da Plataforma**: 86.0%
...
|---|---|---|---|---|---|---|---|---|---|
| 01 | `root` | `.` | `go, shell` | 9931 | 8931 | 160 | 0 | 100% | `verified` |
