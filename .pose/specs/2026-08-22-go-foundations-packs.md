...
- [ ] Aprofundar os oito conceitos existentes de go-data-text com explicações, exemplos Go isolados e relações conceituais válidas; preservar desafios e competências e validar catálogo e matriz strict. Consumir knowledge:go-foundations-io-batch.
