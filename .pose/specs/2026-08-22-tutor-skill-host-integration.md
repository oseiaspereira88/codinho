...
### Affected areas
- .agents/skills/codinho/, testdata/host/
...
- created: .agents/skills/codinho/references/codex-configuration.md
...
- `python3 -c "yaml.safe_load(...)"` em `agents/openai.yaml` e `testdata/host/adversarial-prompts.yaml`, e `tomllib.load` no bloco TOML de `.agents/skills/codinho/references/codex-configuration.md` → todos válidos (2026-08-23).
...
- `.agents/skills/codinho/references/codex-configuration.md` e `agents/openai.yaml` declaram a
...
- `.agents/skills/codinho/references/codex-configuration.md` (criado)
