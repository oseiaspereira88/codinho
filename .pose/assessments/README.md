...
|----|------------|---------------|-----------|--------------|------------|----------|--------|--------------------|
| 01 | `root` | `.` | `go, shell` | 12388 | 11945 | 190 | `verified` | [root.md](./root.md) |
...
| 05 | `cmd-codinho` | `cmd/codinho` | `go` | 103 | 1458 | 9 | `verified` | [cmd-codinho.md](./cmd-codinho.md) |
...
| 08 | `internal-mcpserver` | `internal/mcpserver` | `go` | 1325 | 1891 | 24 | `verified` | [internal-mcpserver.md](./internal-mcpserver.md) |
